...
var $ = require("jquery"),
  ...
  template = require("text-loader!../../templates/grants/item.html"),
  details = require("text-loader!../../templates/grants/details.html");
...
var GrantView = Backbone.View.extend({
  ...
  render: function() {
    ...
    $("title").text(
      "Grant from " +
        this.model.get("field_funder").name +
        " to " +
        this.model.get("field_recipient").name +
        " - The Detroit Ledger"
    );
